...
**建议修改**: they edit the served body and may add a reason of up to 500 characters.
...
otherwise the proposal becomes stale. Declining changes nothing. The proposer is
notified either way and may withdraw an open proposal. Accepted proposers are thanked
in the article footer. Resolved proposal text is cleared after 90 days. See
