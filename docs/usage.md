...
If short-lived verification expires while an operation waits, retry the same operation or continue the original creation request. Expiry alone does not require GitHub authorization again. Reconcile an uncertain remote write before retrying it.
