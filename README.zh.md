...
[内容计划](notes/proposed/2026-09-09-codeact-content-and-media.md)还包括默认私密的 `public/`、`private/` 双根目录、内容转换，以及冗余 MCP 文件工具的移除。这些能力尚未交付，当前发布策略和工具接口见[使用文档](docs/usage.zh.md)。浏览器与 CodeAct 会话已支持将已保存文档与媒体导出为私人或公开 ZIP，包含实际原件和相对链接。
