...
[内容计划](notes/proposed/2026-09-09-codeact-content-and-media.md)仍需完成协调内容转换和最终部署验收。[使用文档](docs/usage.zh.md)定义默认私密的双根目录和 CodeAct 文件入口。浏览器与 CodeAct 会话支持将已保存文档与媒体导出为私人或公开 ZIP，包含实际原件和相对链接。
