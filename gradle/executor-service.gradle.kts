...
val stageExecutorServiceTests = tasks.register<Sync>("stageExecutorServiceTests") {
    from(executorServiceSource) {
        include("worker.py", "disk_pool.py", "resource_pool.py", "session_files.py", "binary_capture.py", "materialize.py", "artifacts.py", "checkpoints.py", "checkpoint_tree.py", "bridge.py", "cli.py", "test_*.py", "run_tests.py", "requirements.txt", "Dockerfile.tests", "java-frames.json", "README.md")
    }
