...
The [content plan](notes/proposed/2026-09-09-codeact-content-and-media.md) retains coordinated content conversion and final deployment acceptance. The [usage reference](docs/usage.md) documents the default-private roots and CodeAct file entrance. The browser and CodeAct sessions export saved documents and media as private or public ZIP packages with actual originals and relative links.
