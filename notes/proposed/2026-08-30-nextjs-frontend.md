...
[Phase-one delivery](../implemented/2026-09-05-phase-one-daily-use.md) includes the public blog and Markdown administration interface with real-browser evidence. Visitor-Q&A controls are excluded from that delivery.
