...
[Phase-one delivery](../implemented/2026-09-05-phase-one-daily-use.md) specifies the delivery scope, excludes visitor Q&A, and limits initial transport to ordinary history fetch with incremental reuse. It does not promise selective cold object transfer. Runtime isolation remains subject to real-host acceptance.
