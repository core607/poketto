...
The first implementation depends on the implemented [workspace boundary](../implemented/2026-08-27-workspace-tenancy.md), [remote repository authority](2026-09-01-remote-repository-authority.md), and [repository-native publishing and images](2026-09-01-repository-native-publishing-and-assets.md). It includes committed-tree reads that tolerate per-file validation failures, bounded in-memory search, `get_file`, `get_asset`, the execution capability and MCP contract, session-scoped commit-pinned workspaces, the separate-account sandbox adapter, resource enforcement, cleanup recovery, audits, and focused security and isolation tests.
