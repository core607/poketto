...
- Focused renderer tests cover PNG/JPEG output, dimension bounds, JPEG EXIF 6/8 orientation, PNG and WebP EXIF chunk orientation and their malformed payloads, actual lossless WebP decoding and rejection above the WebP source cap. Cache tests cover workspace/source isolation, hits, corruption and deletion recovery.
