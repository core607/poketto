...
`RepositoryFilenameSearchTests` covers regular and indexed paths, ordering, links, submodules, bounds and collisions; `RepositoryAdminIntegrationIT` exercises the authenticated endpoint, workspace and permission isolation, current-public restrictions and revocation; `frontend/tests/filename-search.test.tsx` pins commit-bound paging and stale-response handling.

Related: [directory navigation](2026-09-08-repository-directory-navigation.md), [logical media](2026-09-09-logical-media-index.md) and [member permissions](2026-09-12-member-content-permissions.md) own reads, media paths and grants; [search highlights](2026-09-14-search-highlights-and-reading-return.md) owns the escaped `mark` rendering.
