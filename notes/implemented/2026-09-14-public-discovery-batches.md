...
The initial entrance identifies each space and links articles and folder pages. [Public signatures](2026-09-14-public-author-names.md), [collection reading](2026-09-14-collection-reading.md) and [album thumbnails](2026-09-14-album-thumbnails.md) own their subsequent extensions. Homepage album classification and covers, complete site search and reading-return state remain required by the parent contract.
