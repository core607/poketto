...
The [retrieval proposal](../proposed/2026-09-01-repository-native-retrieval-and-sandboxed-execution.md) retains composable execution and its isolation boundary; this decision extends its selection of basic read tools. [Phase-one delivery](../proposed/2026-09-05-phase-one-daily-use.md) retains its remaining client and installation acceptance. No persistent index, new database state or additional execution authority is introduced.
