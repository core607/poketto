...
`PublicFilePresentationTests` pins the scheduled state, and `frontend/tests/editor-navigation.test.tsx` pins publishing against a reported website restriction. The other states, the exact-commit reread after save and the unconfirmed-publication state were demonstrated against the real stack in the [daily-use UI evidence](../../acceptance/evidence/2026-09-14-daily-use-ui.json); no automated test pins them.

Related: [website delivery](2026-09-14-workspace-public-delivery.md), [member permissions](2026-09-12-member-content-permissions.md) and [atomic moves](2026-09-09-atomic-content-moves.md) own the website switch, grants and move rereads.
