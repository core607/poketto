...
[Phase-one delivery](../implemented/2026-09-05-phase-one-daily-use.md) implements the local storage profile and retains all acknowledged managed originals. OSS, physical reclamation, and backup-dependent recovery remain outside that delivery; completing the local profile alone does not implement this entire proposal.
