...
| `MATERIALIZE_BEGIN` | `executionId`, `path`, `bytes` (0 through 128 MiB), `sha256`, `expectedSha256` (null means absent), and `delete`. Allocates one protected incoming file per lease; returns `transferId`. |
